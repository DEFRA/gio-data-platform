...
resource blobprivateEndpoints 'Microsoft.Network/privateEndpoints@2020-11-01' = {
  ...
  properties: {
    ...
    subnet: {
      id: resourceId(tradeVnet.resourceGroup, 'Microsoft.Network/virtualNetworks/subnets', tradeVnet.name, tradeVnet.peSubnet)
    }
    customDnsConfigs: []
  }
  dependsOn: [
